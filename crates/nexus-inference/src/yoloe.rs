...
fn run_yoloe(
    ...
    // M_PERF_CROWD Phase C3 — the shared `crate::nms` module owns the
    // implementation; `nms_spatial_bucket_size_px` opts into the
    // 3×3-neighbourhood fast path (bit-identical when set high enough).
